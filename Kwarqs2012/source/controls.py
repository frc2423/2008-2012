...
BALL_HANDLER_MANUAL_CHAMBER_UP_BUTTON   = (2, 6)
BALL_HANDLER_MANUAL_CHAMBER_DOWN_BUTTON = (2, 7)
BALL_HANDLER_MANUAL_FEEDER_FEED_BUTTON  = (2, 11)
BALL_HANDLER_MANUAL_FEEDER_EXPEL_BUTTON = (2, 10)
